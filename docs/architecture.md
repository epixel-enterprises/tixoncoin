...
Two slightly-obscurely-named components are:
  ...
  - SCP -- "Tixoncoin Consensus Protocol", the component implementing the
    [consensus algorithm](https://www.tixoncoin.org/papers/tixoncoin-consensus-protocol.pdf).
...
- Set of core validator nodes. Running tixoncoin-core only. Tasked with:
...
- Set of public HTTP nodes. Not running tixoncoin-core. Running
...
- (optional): Set of public validator nodes. Running tixoncoin-core only. Tasked
with:
  ...
  - Basically just a tixoncoin-network load balancer / firewall for public access,
