             ...
             public NonMovableOrCopyable
{
  ...
  protected:
    ...
    void recvMessage(TixoncoinMessage const& msg);
    void recvMessage(AuthenticatedMessage const& msg);
    void recvMessage(xdr::msg_ptr const& xdrBytes);

    virtual void recvError(TixoncoinMessage const& msg);
    // returns false if we should drop this peer
    void noteHandshakeSuccessInPeerRecord();
    void recvAuth(TixoncoinMessage const& msg);
    void recvDontHave(TixoncoinMessage const& msg);
    void recvGetPeers(TixoncoinMessage const& msg);
    void recvHello(Hello const& elo);
    void recvPeers(TixoncoinMessage const& msg);

    void recvGetTxSet(TixoncoinMessage const& msg);
    void recvTxSet(TixoncoinMessage const& msg);
    void recvTransaction(TixoncoinMessage const& msg);
    void recvGetSCPQuorumSet(TixoncoinMessage const& msg);
    void recvSCPQuorumSet(TixoncoinMessage const& msg);
    void recvSCPMessage(TixoncoinMessage const& msg);
    void recvGetSCPState(TixoncoinMessage const& msg);
  ...
  public:
    ...
    void sendMessage(TixoncoinMessage const& msg);
