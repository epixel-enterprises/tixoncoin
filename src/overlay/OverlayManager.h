 ...
 * `TixoncoinMessage`, in the file src/xdr/Tixoncoin-overlay.x
 *
 ...
 *
 * The `TixoncoinMessage` union contains 3 logically distinct kinds of message:
 *
...
class OverlayManager
{
  public:
    ...
    // Herder.
    virtual void broadcastMessage(TixoncoinMessage const& msg,
                                  bool force = false) = 0;
    ...
    virtual void recvFloodedMsg(TixoncoinMessage const& msg,
                                Peer::pointer peer) = 0;
