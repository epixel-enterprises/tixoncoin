...
template <>
std::string
toString(tixoncoin::ClaimOfferAtom const& coa)
{
...
template <>
std::string
toString(tixoncoin::Hash const& tr)
{
...
template <>
std::string
toString(tixoncoin::OfferEntry const& oe)
{
...
template <>
std::string
toString(tixoncoin::OfferState const& os)
{
    return fmt::format(
        ...
        os.type == tixoncoin::OfferType::PASSIVE ? "passive" : "active");
}

template <>
std::string
toString(tixoncoin::TransactionResult const& tr)
{
    return xdr::xdr_to_string(tr);
}
...
template <>
std::string
toString(tixoncoin::CatchupRange const& cr)
{
...
template <>
std::string
toString(tixoncoin::historytestutils::CatchupPerformedWork const& cm)
{
    return fmt::format("{}, {}, {}, {}, {}, {}, {}, {}",
