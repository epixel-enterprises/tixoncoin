...
/* TixoncoinValue is the value used by SCP to reach consensus on a given ledger
*/
...
struct LedgerHeader
{
    ...
    TixoncoinValue scpValue;   // what consensus agreed to
...
/* Ledger upgrades
note that the `upgrades` field from TixoncoinValue is normalized such that
