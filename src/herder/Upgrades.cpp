...
void
save(Archive& ar, tixoncoin::Upgrades::UpgradeParameters const& p)
{
    ar(make_nvp("time", tixoncoin::VirtualClock::to_time_t(p.mUpgradeTime)));
...
template <class Archive>
void
load(Archive& ar, tixoncoin::Upgrades::UpgradeParameters& o)
{
    time_t t;
    ar(make_nvp("time", t));
    o.mUpgradeTime = tixoncoin::VirtualClock::from_time_t(t);
