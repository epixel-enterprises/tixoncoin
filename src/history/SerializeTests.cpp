// Copyright 2018 Tixoncoin Development Foundation and contributors. Licensed
...
TEST_CASE("Serialization round-trip", "[history][serialize]")
{
    std::vector<std::string> testFiles = {
        "tixoncoin-history.testnet.6714239.json",
        "tixoncoin-history.livenet.15686975.json"};
