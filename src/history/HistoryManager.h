 ...
 * stored at .well-known/tixoncoin-history.json as a JSON file.
 *
 ...
 *
 * While the _most recent_ checkpoint is in .well-known/tixoncoin-history.json,
...
class HistoryManager
{
  public:
    ...
    // .well-known/tixoncoin-history.json to it.
