...
{
size_t
hash<tixoncoin::PublicKey>::operator()(tixoncoin::PublicKey const& k) const noexcept
{
    assert(k.type() == tixoncoin::PUBLIC_KEY_TYPE_ED25519);

    return std::hash<tixoncoin::uint256>()(k.ed25519());
}
}
