...
Note that you can (and should) install the Windows version of postgres even when running tixoncoin-core from within WSL.


# Basic Installation

- `git clone PATH_TO_TIXONCOIN_CORE`
- `git submodule init`
- `git submodule update`
- Open the solution `Builds\VisualStudio\tixoncoin-core.sln`
